...
class DashboardAPI(object):
    ...
    **Creates a persistent Meraki dashboard API session**
    ...
    - custom_headers (dict): optional extra HTTP headers appended to every request; SDK-managed headers (Authorization, Content-Type, User-Agent) take precedence on collision
