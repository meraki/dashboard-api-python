class Networks(object):
    ...
    def bindNetwork(self, networkId: str, configTemplateId: str, **kwargs):
        ...
        **Bind a network to a template.**
        ...
        - autoBind (string): 'true' or 'false', optional string indicating whether the network's switches should automatically bind to profiles of the same model. Defaults to false if left unspecified. This option only affects switch networks and switch templates. Auto-bind is not valid unless the switch template has at least one profile and has at most one profile per switch model.
        """
