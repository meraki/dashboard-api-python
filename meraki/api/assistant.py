...
class Assistant(object):
    ...
    def createOrganizationAssistantChatCompletion(self, organizationId: str, **kwargs):
        ...
        **Create a chat completion with the AI assistant**
        ...
        if "platform" in kwargs:
            ...
            assert kwargs["platform"] in options, f'''"platform" cannot be "{kwargs['platform']}", & must be set to one of: {options}'''
        ...
        body_params = ["query", "content", "threadId", "networkId", "platform", "language", "country", ]
    ...
    def getOrganizationAssistantChatThreads(self, organizationId: str, total_pages=1, direction='next', **kwargs):
        ...
        **List all active conversation threads for the authenticated user.**
        ...
        query_params = ["perPage", "sort", "sortOrder", "from", "to", ]
        ...
        if self._session._validate_kwargs:
            ...
            if invalid and self._session._logger:
                self._session._logger.warning(
                    f"getOrganizationAssistantChatThreads: ignoring unrecognized kwargs: {invalid}"
                )
    ...
    def getOrganizationAssistantChatThreadMessages(self, organizationId: str, threadId: str, total_pages=1, direction='next', **kwargs):
        """
        **List messages in a conversation thread.**
        ...
        query_params = ["perPage", "sortOrder", ]
        params = {k.strip(): v for k, v in kwargs.items() if k.strip() in query_params}
    ...
    def createOrganizationAssistantChatThreadMessage(self, organizationId: str, threadId: str, content: list, **kwargs):
        ...
        **Create a new chat message in a thread.**
        ...
        body_params = ["content", "networkName", "networkId", ]
        payload = {k.strip(): v for k, v in kwargs.items() if k.strip() in body_params}
    ...
    def getOrganizationAssistantChatThreadMessageArtifact(self, organizationId: str, threadId: str, messageId: str, artifactId: str):
        """
        **Return a single artifact with its full content.**
        ...
        resource = f"/organizations/{organizationId}/assistant/chat/threads/{threadId}/messages/{messageId}/artifacts/{artifactId}"
    ...
    def createOrganizationAssistantChatThreadMessageFeedback(self, organizationId: str, threadId: str, messageId: str, vote: bool, **kwargs):
        """
        **Submit or replace feedback for a specific assistant message.**
        ...
        body_params = ["vote", "reason", "comment", "message", "prompt", ]
        payload = {k.strip(): v for k, v in kwargs.items() if k.strip() in body_params}
    ...
    def getOrganizationAssistantQuery-limits(self, organizationId: str):
        """
        **Get query limits for the AI assistant for this organization.**
        ...
        metadata = {
            "tags": ["assistant", "configure", "query-limits"],
            "operation": "getOrganizationAssistantQuery-limits",
        }
        organizationId = urllib.parse.quote(str(organizationId), safe="")
        resource = f"/organizations/{organizationId}/assistant/query-limits"
