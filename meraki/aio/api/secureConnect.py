...
class AsyncSecureConnect:
    ...
    def getOrganizationSecureConnectPrivateApplicationGroups(self, organizationId: str, total_pages=1, direction='next', **kwargs):
        """
        **Provides a list of private application groups for an Organization**
        ...
        query_params = ["perPage", "startingAfter", "endingBefore", "nameIncludes", "applicationGroupIds", "sortBy", "sortOrder", ]
        params = {k.strip(): v for k, v in kwargs.items() if k.strip() in query_params}

        array_params = ["applicationGroupIds", ]
    ...
    def createOrganizationSecureConnectPrivateApplicationGroup(self, organizationId: str, name: str, **kwargs):
        ...
        **Creates a group of private applications to apply to policy**
        ...
        body_params = ["name", "description", "applicationIds", ]
    ...
    def getOrganizationSecureConnectPrivateApplications(self, organizationId: str, total_pages=1, direction='next', **kwargs):
        ...
        **Provides a list of private applications for an Organization.**
        ...
        query_params = ["perPage", "startingAfter", "endingBefore", "nameIncludes", "applicationGroupIds", "appTypes", "sortBy", "sortOrder", ]
        params = {k.strip(): v for k, v in kwargs.items() if k.strip() in query_params}

        array_params = ["applicationGroupIds", "appTypes", ]
        for k, v in kwargs.items():
            if k.strip() in array_params:
                params[f"{k.strip()}[]"] = kwargs[f"{k}"]
                params.pop(k.strip())
    ...
    def createOrganizationSecureConnectPrivateApplication(self, organizationId: str, name: str, destinations: list, **kwargs):
        ...
        **Adds a new private application to the Organization**
        ...
        body_params = ["name", "description", "destinations", "appProtocol", "sni", "externalFQDN", "sslVerificationEnabled", "applicationGroupIds", ]
        payload = {k.strip(): v for k, v in kwargs.items() if k.strip() in body_params}
    ...
    def updateOrganizationSecureConnectPrivateApplication(self, organizationId: str, id: str, name: str, destinations: list, **kwargs):
        """
    ...
    def createOrganizationSecureConnectPrivateResourceGroup(self, organizationId: str, name: str, **kwargs):
        ...
        **Adds a new private resource group to an organization.**
        ...
        body_params = ["name", "description", "resourceIds", ]
        payload = {k.strip(): v for k, v in kwargs.items() if k.strip() in body_params}
    ...
    def getOrganizationSecureConnectPrivateResources(self, organizationId: str, total_pages=1, direction='next', **kwargs):
        ...
        **Provides a list of private resources for an organization.**
        ...
        query_params = ["perPage", "startingAfter", "endingBefore", "sortBy", "sortOrder", ]
        params = {k.strip(): v for k, v in kwargs.items() if k.strip() in query_params}
    ...
    def createOrganizationSecureConnectPrivateResource(self, organizationId: str, name: str, accessTypes: list, resourceAddresses: list, **kwargs):
        """
        **Adds a new private resource to the organization.**
        ...
        body_params = ["name", "description", "accessTypes", "resourceAddresses", "resourceGroupIds", ]
        payload = {k.strip(): v for k, v in kwargs.items() if k.strip() in body_params}
    ...
    def updateOrganizationSecureConnectPrivateResource(self, organizationId: str, id: str, name: str, accessTypes: list, resourceAddresses: list, **kwargs):
        """
    ...
    def getOrganizationSecureConnectPublicApplications(self, organizationId: str, total_pages=1, direction='next', **kwargs):
        ...
        **Provides a list of public applications for an Organization.**
        ...
        query_params = ["perPage", "startingAfter", "endingBefore", "nameIncludes", "risks", "categories", "appTypes", "t0", "t1", "timespan", "sortBy", "sortOrder", ]
        params = {k.strip(): v for k, v in kwargs.items() if k.strip() in query_params}

        array_params = ["risks", "categories", "appTypes", ]
        for k, v in kwargs.items():
            if k.strip() in array_params:
                params[f"{k.strip()}[]"] = kwargs[f"{k}"]
                params.pop(k.strip())
    ...
    def getOrganizationSecureConnectRegions(self, organizationId: str, **kwargs):
        ...
        **List deployed cloud hubs and regions in this organization**
        ...
        if "regionType" in kwargs:
            ...
            assert kwargs["regionType"] in options, f'''"regionType" cannot be "{kwargs['regionType']}", & must be set to one of: {options}'''
        ...
        if self._session._validate_kwargs:
            ...
            if invalid and self._session._logger:
                self._session._logger.warning(
                    f"getOrganizationSecureConnectRegions: ignoring unrecognized kwargs: {invalid}"
                )
    ...
    def getOrganizationSecureConnectRemoteAccessLog(self, organizationId: str, total_pages=1, direction='next', **kwargs):
      ...
      versions to filter the data.
        ...
        if "connectionevent" in kwargs:
            ...
            assert kwargs["connectionevent"] in options, f'''"connectionevent" cannot be "{kwargs['connectionevent']}", & must be set to one of: {options}'''
        ...
        query_params = ["perPage", "startingAfter", "endingBefore", "t0", "t1", "timespan", "identityids", "identitytypes", "connectionevent", "anyconnectversions", "osversions", ]
        params = {k.strip(): v for k, v in kwargs.items() if k.strip() in query_params}
    ...
    def getOrganizationSecureConnectRemoteAccessLogsExports(self, organizationId: str, total_pages=1, direction='next', **kwargs):
        """
        **Provides a list of remote access logs exports for an Organization**
        ...
        query_params = ["perPage", "startingAfter", "endingBefore", "status", ]
        params = {k.strip(): v for k, v in kwargs.items() if k.strip() in query_params}
    ...
    def createOrganizationSecureConnectRemoteAccessLogsExport(self, organizationId: str, from: int, to: int, **kwargs):
        """
    ...
    def getOrganizationSecureConnectRemoteAccessLogsExportsDownload(self, organizationId: str, id: str, fileType: str, **kwargs):
        """
    ...
    def getOrganizationSecureConnectSites(self, organizationId: str, total_pages=1, direction='next', **kwargs):
        ...
        **List sites in this organization**
        ...
        if "enrolledState" in kwargs:
            ...
            assert kwargs["enrolledState"] in options, f'''"enrolledState" cannot be "{kwargs['enrolledState']}", & must be set to one of: {options}'''
        ...
        query_params = ["perPage", "startingAfter", "endingBefore", "search", "enrolledState", ]
        params = {k.strip(): v for k, v in kwargs.items() if k.strip() in query_params}
        ...
        if self._session._validate_kwargs:
            ...
            if invalid and self._session._logger:
                self._session._logger.warning(
                    f"getOrganizationSecureConnectSites: ignoring unrecognized kwargs: {invalid}"
                )
    ...
    def createOrganizationSecureConnectSite(self, organizationId: str, **kwargs):
        ...
        **Enroll sites in this organization to Secure Connect**
        ...
        body_params = ["enrollments", "callback", ]
        payload = {k.strip(): v for k, v in kwargs.items() if k.strip() in body_params}
        ...
        if self._session._validate_kwargs:
            ...
            if invalid and self._session._logger:
                self._session._logger.warning(
                    f"createOrganizationSecureConnectSite: ignoring unrecognized kwargs: {invalid}"
                )
