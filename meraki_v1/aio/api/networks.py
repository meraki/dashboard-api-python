class AsyncNetworks:
    ...
    async def provisionNetworkClients(self, networkId: str, clients: list, devicePolicy: str, **kwargs):
        """
    ...
    async def claimNetworkDevices(self, networkId: str, serials: list):
        """
    ...
    async def removeNetworkDevices(self, networkId: str, serial: str):
        """
    ...
    async def getNetworkSettings(self, networkId: str):
        """
    ...
    async def updateNetworkSettings(self, networkId: str, **kwargs):
        """
